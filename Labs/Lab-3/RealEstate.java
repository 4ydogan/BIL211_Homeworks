public class RealEstate {
    public static void main(String [] args){
        Estate apart1 = new Apartment("860 Glenwood Ave SE, Atlanta, GA 30316", 3, "East", 4, 250, 4);
        Estate apart2 = new Apartment("392 Central Park W APT 12G, New York, NY 10025", 11, "North", 6, 250, 5);
        Estate apart3 = new Apartment("60 E 9th St APT 339, New York, NY 10003", -2, "West", 1, 75, 2);
        Estate house1 = new House("105 E 2nd St, Brooklyn, NY 11218", 3, "West", 5, 300, 3);
        Estate house2 = new House("600 N Pine St E, Brooklyn, NY 11208", 4, "South", 7, 450, 5);
        ...
        Estate house3 = house2.copy();
        house3.setAddress("111-37 156, Jamaica, NY 11433");
        house3.setFloor(5);
        house3.setAream2(500);
